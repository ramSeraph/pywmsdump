...
class TestGeorssParsing(TestCase):
    ...
    def test_wms_capabilities_bug(self):
        ...
        #Path('out.json').write_text(json.dumps({ 'service_info': service_info, 'layer_list': layer_list }))
    ...
    def test_wfs_disabled_ows_namespace(self):
        ...
        self.assertRaises(WFSUnsupportedException, parse_capabilities, 'WFS', xml_txt, [], {})
